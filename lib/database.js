...
const settingsSchema = new mongoose.Schema({
  ...
  MV_SIZE: { type: String, default: "0" },
    GITHUB_TOKEN: { type: String, default: "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" },
  GITHUB_OWNER: { type: String, default: "Nadeenpoorna-app" },
  GITHUB_REPO: { type: String, default: "movie-plans" },
  ...
  JID3: {
      type: String,
      default: '120363424608505553@g.us',
    },  
  RV: {
      type: String,
      default: '94716769285@s.whatsapp.net',
    },  
  BUTTON3: {
      type: String,
      default: 'false',
...
LOGO: { 
  type: String, 
  default: "https://nadeen-botzdatabse.vercel.app/MOVIExGO.png" 
},
MAINMENU: { 
  type: String, 
