...
const responsee = await axios.get('https://nadeen-botzdatabse.vercel.app/data.json');
...
conn.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
        ...
        try {
            const res = await axios.get('https://nadeen-botzdatabse.vercel.app/data.json');
...
async function autoJoinGroup(conn) {
    try {
        ...
        let joinlink2 = await fetchJson('https://nadeen-botzdatabse.vercel.app/data.json');
...
const ownerdataa = (await axios.get('https://nadeen-botzdatabse.vercel.app/data.json')).data;
...
const ownerdata = (await axios.get('https://nadeen-botzdatabse.vercel.app/data.json')).data
...
const preUser = await fetchJson(`https://nadeen-botzdatabse.vercel.app/prem/numbers.json`)
...
//
    try {
cmd.function(conn, mek, m, { from, prefix, l, isSudo, quoted, body, isCmd, isPre, getPremiumInfo, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply });
    } catch (e) {
...
events.commands.map(async (command) => {
  if (body && command.on === "body") {
    command.function(conn, mek, m, { from, prefix, l, isSudo, quoted, isPre, body, isCmd, getPremiumInfo, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply })
  } else if (mek.q && command.on === "text") {
    command.function(conn, mek, m, { from, l, quoted, body, isSudo, isCmd, isPre, getPremiumInfo, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply })
  } else if (
    (command.on === "image" || command.on === "photo") &&
    mek.type === "imageMessage"
  ) {
    command.function(conn, mek, m, { from, prefix, l, quoted, isSudo, body, isCmd, getPremiumInfo, command, isPre, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply })
  } else if (
    command.on === "sticker" &&
    mek.type === "stickerMessage"
  ) {
    command.function(conn, mek, m, { from, prefix, l, quoted, isSudo, body, isCmd, getPremiumInfo, command, args, isPre, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply })
  }
});
